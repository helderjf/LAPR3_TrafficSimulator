 ...
 */
public class BestPathAnalysisChooseVehiclePane extends javax.swing.JPanel {

    BestPathAnalysisFrame m_ancestor;
    ModelList<Vehicle> m_modelVehicles;

    /**
     * Creates new form BestPathAnalysisPane
     */
    public BestPathAnalysisChooseVehiclePane(BestPathAnalysisFrame ancestor, ArrayList<Vehicle> list) {

        m_ancestor=ancestor;
        m_modelVehicles = new ModelList();
        m_modelVehicles.setItems(list);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jList1.getSelectedValue() != null) {
            m_ancestor.setVehicle((Vehicle)jList1.getSelectedValue());
            //m_mainFrame = new MainFrame(m_mainFrame.getManager());
        } else {
            JOptionPane.showMessageDialog(this, "You must select one vehicle", "Vehicle selection", JOptionPane.INFORMATION_MESSAGE);
        }
