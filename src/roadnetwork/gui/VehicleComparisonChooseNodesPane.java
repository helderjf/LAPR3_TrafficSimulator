 ...
 * @author josemiranda
 */
public class VehicleComparisonChooseNodesPane extends javax.swing.JPanel {

    VehicleComparisonFrame m_ancestorFrame;
    RoadNetwork m_roadNetwork;
    ModelList<Junction> m_nodesListModel;
    
    /**
     * Creates new form VehicleComparisonChooseNodesPane
     */
    public VehicleComparisonChooseNodesPane(VehicleComparisonFrame ancestor, ArrayList<Junction> nodesList) {
        
        m_ancestorFrame=ancestor;
        m_nodesListModel= new ModelList<>();
        m_nodesListModel.addItems(nodesList);
        initComponents();
    }
